export const clothes = [
    ...
    },
    {
        id: "26",
        category: "Подарки",
        name: "Подарочный бокс для нее",
        description: "С трепетом и большой любовью подобраны все компоненты подарочного бокса. Травы собирались в экологически чистом районе Татарстана, затем придавались естественной сушке. Фартук и прихватки ручной работа, выполнены из 100% хлопка. Косметички также ручной работы. Мягкие, стеганные на подкладке из хлопка. Делитесь своей любовью и дарите своим близким заботу и признательность через подарочные боксы: -черный чай соцветиями смородины; -черный чай соцветиями клевера и зверобоя; -стеганные косметички (2 шт., размер: S,M); -2 прихватки; -фартук",
        image1: "../images/clothes/id1I1.jpg",
        image2: "../images/clothes/id1I2.jpg",
        image3: "../images/clothes/id1I3.jpg",
        color: "Коричневый",
    ...
    },
    {
        ...
        description: "Наполнение подарочного бокса: -черный час соцветиями клевера и зверобоя, -мягкие, стеганные косметички 2 шт. (размер: S,M).",
        image1: "../images/clothes/id1I1.jpg",
        image2: "../images/clothes/id1I2.jpg",
        image3: "../images/clothes/id1I3.jpg",
        color: "Коричневый",
    ...
    },
    {
        ...
        category: "Подарки",
        name: "Косметички",
        description: "Мягкие, нежные, легкие, стеганные косметички. Косметичка идеально вмещает себя косметику, дорожные принадлежности, канцелярию, аксессуары для волос, украшения. Незаменимый аксессуар для поездок и путешествий. Удобен в использовании: в машине, на прогулке, в поезде, в самолете.",
        image1: "../images/clothes/id1I1.jpg",
        image2: "../images/clothes/id1I2.jpg",
        image3: "../images/clothes/id1I3.jpg",
        color: "Клетка",
