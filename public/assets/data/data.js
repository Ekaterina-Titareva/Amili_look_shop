...
export const goods = [
    {
        ...
        },
        {
            ...
            category: "Комплекты",
            name: "Рубашка + брюки",
            description: "Классическая рубашка из мягкой струящейся вискозной ткани. Брюки свободного кроя, пояс на резинке. Принт: цветочный. Комфортный, легкий, красивый летний образ. К комплекту идет топ на завязках.",
        ...
        },
        {
            ...
            description: ["Платье с глубоким декольте подчеркнет вашу королевскую осанку, красивую шею и хрупкий силуэт.", "Мы сшили его из дышащего льна с добавлением вискозы, который придает материалу сияние и гладкость.", "Благодаря простому крою и эффектным рукавам платье получилось женственным и очень нежным.", "Осталось лишь добавить босоножки на каблуке и маленькую сумку."],
        ...
        },
        {
            ...
            description: ["Комфортное платье на каждый день — прямое, длинное, со скрытыми застежками (пуговицами).", "В комплекте идет пояс в тон, можно носить с поясом или без него, подчеркнув силуэт оверсайз и сделав акцент на талии.", "Выполнено из гладкой, матовой, пластичной и легкой ткани."],
        ...
        },
        {
            ...
            category: "Юбки",
            name: "Юбка из шитья",
            description: "Юбка мини из хлопкового шитья, с красивым набивным рисунком. Отлично сочетается с нашими базовыми футболками, свитшотами, рубашками. Дополнить образ можно с казаками, босоножками.",
        ...
        },
        {
            ...
            description: ["Струящаяся юбка, скроенная по косой, красиво подчеркивает бедра и спадает вниз волнами.", "Округлые плавные линии и глянцевый блеск придает юбке особый акцент.", "Шелк-сатин, из которого выполнена модель, несложный в уходе и мало мнется.", "Комбинируйте с топом, жакетом из нашей коллекции.", "Деликатный материал требует бережного ухода."],
        ...
        },
        {
            ...
            description: ["Аккуратная, чуть укороченная модель с втачным рукавом и красивыми перламутровыми пуговицами.", "Жакет настолько уютный и универсальный, что сразу станет любимым.", "Плотное комбинированное переплетение делает твидовый трикотаж ровным и гладким — благодаря этому жакет со временем не потеряет форму.", "Комбинируйте с атласной юбкой из нашей коллекции.", "Уход: деликатная стирка до 40°C, не отбеливать, сушка на плоскости, температура утюга до 110°C, сухая чистка (химчистка)."],
        ...
        },
        {
            ...
            description: ["С трепетом и большой любовью подобраны все компоненты подарочного бокса.", "Травы собирались в экологически чистом районе Татарстана, затем придавались естественной сушке.", "Косметички также ручной работы. Мягкие, стеганные на подкладке из хлопка.", "Делитесь своей любовью и дарите своим близким заботу и признательность через подарочные боксы:", " - черный чай с соцветиями клевера и зверобоя;",  " - резинка для волос;", " - мягкие, стеганные косметички 2 шт. (размер: S,M)."],
        ...
        },
        {
            ...
            description: ["Длинное платье с воротником-стойкой — лаконичная модель, формирующая графичный женственный силуэт.", "Оно садится точно по фигуре, а длинный узкий рукав дополнен манжетами.", "С помощью пришивного пояса на пуговицах прямой силуэт делает образ приталенным."],
        ...
        },
        {
            ...
            category: "Кардиганы",
            name: "Кимоно из льна",
            description: ["Кимоно свободного кроя с отдельным широким поясом. Спущенная линия плеча и расклешенный рукав с ассиметричным кроем.", "Кимоно можно носить самостоятельно как платье, накидку или халат.", "Лаконичный крой позволяет носить его как городской образ, так и дома или на отдыхе.", "Все швы обработаны премиальным закрытым бельевым швом."],
            image1: "/assets/images/clothes/id31I1.jpg",
            image2: "/assets/images/clothes/id31I2.jpg",
            image3: "/assets/images/clothes/id31I3.jpg",
            color: "На Ваш выбор",
            size: "one size",
            price: "8000",
            material: "100% лен",
        ...
        },
        {
            ...
            categoryEng: "dress",
            category: "Платья",
            name: "Платье из муслина",
            description: ["Платье из муслина свободного кроя, с длинными рукавами и декоративной сборкой.", "Легкое, воздушное платье из мягкого муслина позволяет телу дышать, приятен к телу.", "Благодаря такому свободному крою, платье обеспечивает свободу и не сковывает движения.", "Отличный вариант, как на прогулку по городу, так и на отдых."],
            image1: "/assets/images/clothes/id32I1.jpg",
            image2: "/assets/images/clothes/id32I2.jpg",
            image3: "/assets/images/clothes/id32I3.jpg",
            color: "Белый, Голубой",
            size: "42-52",
            price: "7000",
            material: "100% хлопок (муслин)",
            text1: "Возможен индивидуальный пошив по вашим меркам и в других расцветках.",
            text2: "Наш менеджер свяжется с Вами для уточнения деталей после оформления предзаказа."
        },
        {
            ...
            categoryEng: "cardigan",
            category: "Кардиганы",
            name: "Кардиган с перьями фламинго",
            description: ["Кардиган выполнен из вязаного полотна. Полуприлегающий крой, длинный рукав, без застежек, на подкладке.", "Элегантный, эффектный образ на каждый день. Образ, который хочется разглядывать.", "Отлично сочетается с платьем-комбинацией из нашей коллекции + чокер-цветок."],
            image1: "/assets/images/clothes/id33I1.jpg",
            image2: "/assets/images/clothes/id33I2.jpg",
            image3: "/assets/images/clothes/id33I3.jpg",
            color: "Приглушенно-розовый",
            size: "one size",
            price: "10000",
            material: "100% п/э",
            text1: "Возможен индивидуальный пошив по вашим меркам и в других расцветках.",
        ...
        },
        {
            ...
            categoryEng: "scirt",
            category: "Юбки",
            name: "Юбка с клиньями",
            description: "Юбка полусолнце с клиньями выполнен из вискозы с креш-эффектом. Не мнется, не нужно гладить, красивая, женственная юбка, которая должна быть у каждой девушки. На подкладе.",
            image1: "/assets/images/clothes/id34I1.jpg",
            image2: "/assets/images/clothes/id34I2.jpg",
            image3: "/assets/images/clothes/id34I3.jpg",
            color: "На Ваш выбор",
            size: "one size",
            price: "5000",
            material: "60% вискоза, 40% п/э",
            text1: "Возможен индивидуальный пошив по вашим меркам и в других расцветках.",
            text2: "Наш менеджер свяжется с Вами для уточнения деталей после оформления предзаказа."
        }
    ]
