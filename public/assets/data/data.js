...
export const goods = [
    {
        ...
        },
        {
            ...
            category: "Кардиганы",
            name: "Кимоно из льна",
            description: ["Кимоно свободного кроя с отдельным широким поясом. Спущенная линия плеча и расклешенный рукав с ассиметричным краем. Кимоно можно носить самостоятельно как платье, накидку или халат.", "Лаконичный крой позволяет носить его как городской образ, так и на отдыхе, дома. Все швы обработаны премиальным, закрытым бельевым швом."],
        ...
        },
        {
            ...
            description: "Кардиган выполнен из вязаного полотна.  Полуприлегающий крой, длинный рукав, без застежек, на подкладке. Элегантный, эффектный образ на каждый день. Образ, который хочет разглядывать. Отлично сочетается с платьем-комбинация из нашей коллекции + чокер-цветок.",
        ...
        },
        {
            ...
            description: "Юбка полусолнца с клиньями выполнен из вискозы с креш-эффектом. Не мнется, не нужно гладить, красивая, женственная юбка должна быть у каждой девушки. На подкладе.",
